...
export type ActionResult<TData extends JsonObject = JsonObject> = RoutedResult<
  ActionStatus,
  TData
> & {
  page?: PageOutput
...
export type Agent<
  Input = unknown,
  Result extends RoutedResult = RoutedResult,
...
export type Until<Input = unknown> = (
  input: Input,
...
export function agent<
  Input = unknown,
  Result extends RoutedResult = RoutedResult,
>(fn: Agent<Input, Result>): Agent<Input, Result> {
  return fn
}
